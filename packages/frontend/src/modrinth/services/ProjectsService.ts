...
export class ProjectsService {
   ...
   * @throws ApiError
   */
  public getProject(idSlug: string): CancelablePromise<Project> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/project/{id|slug}',
      path: {
   ...
   * @throws ApiError
   */
  public modifyProject(idSlug: string, requestBody?: EditableProject): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'PATCH',
      url: '/project/{id|slug}',
      path: {
   ...
   * @throws ApiError
   */
  public deleteProject(idSlug: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/project/{id|slug}',
      path: {
   ...
   * @throws ApiError
   */
  public getProjects(ids: string): CancelablePromise<Array<Project>> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/projects',
      query: {
   ...
   * @throws ApiError
   */
  public patchProjects(ids: string, requestBody?: PatchProjectsBody): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'PATCH',
      url: '/projects',
      query: {
   ...
   * @throws ApiError
   */
  public randomProjects(count: number): CancelablePromise<Array<Project>> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/projects_random',
      query: {
   ...
   * @throws ApiError
   */
  public createProject(formData?: CreateProjectBody): CancelablePromise<Project> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/project',
      formData: formData,
   ...
   * @throws ApiError
   */
  public deleteProjectIcon(idSlug: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/project/{id|slug}/icon',
      path: {
   ...
   * @throws ApiError
   */
  public checkProjectValidity(idSlug: string): CancelablePromise<ProjectIdentifier> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public deleteGalleryImage(idSlug: string, url: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/project/{id|slug}/gallery',
      path: {
   ...
   * @throws ApiError
   */
  public getDependencies(idSlug: string): CancelablePromise<ProjectDependencyList> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public followProject(idSlug: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'POST',
   ...
   * @throws ApiError
   */
  public unfollowProject(idSlug: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/project/{id|slug}/follow',
      path: {
   ...
   * @throws ApiError
   */
  public scheduleProject(idSlug: string, requestBody?: Schedule): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'POST',
