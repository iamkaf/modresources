...
export class VersionsService {
   ...
   * @throws ApiError
   */
  public getVersion(id: string): CancelablePromise<Version> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/version/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public modifyVersion(id: string, requestBody?: EditableVersion): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'PATCH',
      url: '/version/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public deleteVersion(id: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/version/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public getVersionFromIdOrNumber(idSlug: string, idNumber: string): CancelablePromise<Version> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public createVersion(formData?: CreateVersionBody): CancelablePromise<Version> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/version',
      formData: formData,
   ...
   * @throws ApiError
   */
  public scheduleVersion(id: string, requestBody?: Schedule): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'POST',
   ...
   * @throws ApiError
   */
  public getVersions(ids: string): CancelablePromise<Array<Version>> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/versions',
      query: {
