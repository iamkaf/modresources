...
export class ThreadsService {
   ...
   * @throws ApiError
   */
  public submitReport(requestBody?: CreatableReport): CancelablePromise<Report> {
   ...
   * @throws ApiError
   */
  public getOpenReports(count?: number): CancelablePromise<Array<Report>> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/report',
      query: {
   ...
   * @throws ApiError
   */
  public getReport(id: string): CancelablePromise<Report> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/report/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public getReports(ids: string): CancelablePromise<Array<Report>> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/reports',
      query: {
   ...
   * @throws ApiError
   */
  public getThread(id: string): CancelablePromise<Thread> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/thread/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public sendThreadMessage(id: string, requestBody?: ThreadMessageBody): CancelablePromise<Thread> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/thread/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public getThreads(ids: string): CancelablePromise<Array<Thread>> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/threads',
      query: {
   ...
   * @throws ApiError
   */
  public deleteThreadMessage(id: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/message/{id}',
      path: {
