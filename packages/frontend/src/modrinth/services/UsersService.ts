...
export class UsersService {
   ...
   * @throws ApiError
   */
  public getUser(idUsername: string): CancelablePromise<User> {
   ...
   * @throws ApiError
   */
  public modifyUser(idUsername: string, requestBody?: EditableUser): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'PATCH',
      url: '/user/{id|username}',
      path: {
   ...
   * @throws ApiError
   */
  public getUsers(ids: string): CancelablePromise<Array<User>> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/users',
      query: {
   ...
   * @throws ApiError
   */
  public changeUserIcon(idUsername: string, requestBody?: Blob): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'PATCH',
   ...
   * @throws ApiError
   */
  public deleteUserIcon(idUsername: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/user/{id|username}/icon',
      path: {
   ...
   * @throws ApiError
   */
  public getUserProjects(idUsername: string): CancelablePromise<Array<Project>> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public getFollowedProjects(idUsername: string): CancelablePromise<Array<Project>> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public getPayoutHistory(idUsername: string): CancelablePromise<UserPayoutHistory> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public withdrawPayout(idUsername: string, amount: number): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/user/{id|username}/payouts',
      path: {
