...
export class VersionFilesService {
   ...
   * @throws ApiError
   */
  public getLatestVersionFromHash(
    hash: string,
    algorithm: 'sha1' | 'sha512' = 'sha1',
   ...
   * @throws ApiError
   */
  public versionsFromHashes(requestBody?: HashList): CancelablePromise<HashVersionMap> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/version_files',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public getLatestVersionsFromHashes(requestBody?: GetLatestVersionsFromHashesBody): CancelablePromise<HashVersionMap> {
    return this.httpRequest.request({
      method: 'POST',
