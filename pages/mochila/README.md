...
A colorful upgradable backpack mod for Fabric, Forge, and NeoForge.
...
Backpacks can be renamed in an anvil, dyed with any vanilla dye, and upgraded through the material tiers. Upgrades preserve the backpack's contents, name, mode, and color.
...
Mochila shows how many items were moved and which container received them. The target block list is configurable; chests, barrels, trapped chests, and copper chest variants are enabled by default.
...
You can view the custom backpack coloring and crafting upgrade recipes with [JEI](https://modrinth.com/mod/jei) on Fabric and NeoForge.


### Configuration

Mochila includes in-game configuration screens through [Konfig](https://modrinth.com/mod/konfig) where supported. Use the config to tune quick stash targets without editing code or datapacks.


### Current Plan

The development plan is to keep Mochila current with new Minecraft releases and improve optional mod integration. If you have any requests for features or mod compats let me know.
...
- ~~Add a config file~~ - v6.0.0
- Add more recipe viewer integrations when REI and EMI support the current Minecraft version
- Backport to 1.20.1
...
{{snippet:promo mods=bonded,gentlehurtcam,happyghastimprovements,liteminer}}
